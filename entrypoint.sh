...
if [ ! -f "/data/post_consumption_hook.py" ]; then
  echo "Copying post-consumption hook script to /data directory..."
  cp /app/post_consumption_hook.py /data/post_consumption_hook.py
  chmod +x /data/post_consumption_hook.py
fi
